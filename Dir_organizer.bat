...
call :move_files "Software" exe msi deb rpm dmg  appimage sh jar bin run
call :move_files "Docs" doc docx dot dotx xls xlsx xlsm xlt xltx ppt pptx pps ppsx pot potx mdb accdb pub one odt ods odp odg odf pdf xps txt rtf csv  tex epub chm djvu
call :move_files "Archives" zip rar 7z tar gz bz2 xz iso cab arj lzh ace z arc jar war apk deb pkg tar.gz tar.bz2 tar.xz tgz tbz txz
